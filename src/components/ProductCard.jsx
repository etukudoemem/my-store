    ...
    return (
        <>
            <Link to={`/product/${id}`} className="scroll" >
                <div className="lg:min-w-[100px] lg:h-[auto] sm:h-170 sm:min-w-[440px]
                    sm:shadow-lg lg:shadow-xs lg:py-2" >
                    ...
                    <p className="text-gray-700 lg:px-2 sm:px-4 my-2 lg:text-[13px] sm:text-[2rem]
                        sm:w-100 lg:w-full lg:mb-1 sm:mb-3 leading-tight sm:font-light ">
                        {name}
                    </p>
                    <p className="font-semibold text-gray-600 lg:px-2 sm:px-4 mb-2 lg:text-sm sm:text-[2rem]
                        ">
                        ${price}
                    </p>
                </div>
