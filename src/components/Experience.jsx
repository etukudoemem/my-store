    ...
    return (
        <>
            <section className="lg:mt-30 flex justify-evenly lg:flex-row lg:mb-20 
                ...
                <div className="flex sm:flex-col items-center lg:mb-0 sm:mb-20">
                    <div className="lg:w-[40px] mb-6 sm:w-20">
                        <img src={exchangeIcon} alt="" />
                    </div>
                    <p className="font-medium lg:text-base sm:text-4xl lg:mb-0 sm:mb-6">
                ...
                <div className="flex flex-col items-center lg:mb-0 sm:mb-15">
                    <div className="lg:w-[40px] lg:mb-6 sm:w-20">
