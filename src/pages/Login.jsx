                    ...
                    <form onSubmit={(e) => logInUser(e)}>
                        <div className="flex flex-col lg:gap-6 sm:gap-14 justify-center items-center m-4
                            ...
                            <input onChange={(e) => getUserInfo(e)}
                                ...
                                lg:outline-none p-3 lg:px-4 sm:px-8 border-1 leftHeader bg-slate-100 sm:font-light lg:font-normal
                            ...
                            <input onChange={(e) => getUserInfo(e)}
                                className={`lg:w-100 sm:w-full lg:h-11 sm:h-30 text-gray-600 placeholder-gray-300
                                active:scale-98 transition-all duration-200 ease-in-out lg:text-base sm:text-5xl
                                lg:outline-none p-3 lg:px-4 sm:px-8 border-1 rightHeader bg-slate-100 sm:font-light lg:font-normal
                                ${noLoginInput.password ? "border-red-600 border-2" : "border-gray-600"}`}
                        ...
                        <div className="flex justify-between lg:mt-[-5px] sm:mt-8 lg:text-sm sm:text-4xl lg:font-medium
                            text-gray-600 collections sm:px-4 lg:px-0 sm:font-light">
